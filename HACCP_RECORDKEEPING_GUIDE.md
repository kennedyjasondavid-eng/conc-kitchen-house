...
**Date:** 2026-06-24 · **Status: WORKING DRAFT.** The critical-limit *values* below are **validated** (2026-06-24, see `HACCP_REGULATORY_FINDINGS.md`); **`HACCP_HAZARD_ANALYSIS.md` §4 remains the single source of truth.** Voluntary plan — standard O. Reg. 493/17 inspection only; no TPH ROP review.
...
|---|---|---|---|---|---|---|---|
| 1 | **Cook / Cool / Reheat batch log** | CCP-1, 2, 4 | item · date · cook °C · cool@2h °C · cool@6h °C · reheat °C · initials | per batch | cook | HUB chip-tap → log | 2 yr* |
| 2 | **Fridge / cold-hold log** | CCP-3 | unit · temp · time · initials | **2×/day** per unit | lead | HUB / paper | 2 yr* |
...
| 4 | **Transport equipment validation** | CCP-3 cold chain | validated insulated/refrigerated transport; documented capability *(no per-leg log — CONC decision)* | commissioning + annual | logistics | binder | current |
| 5 | **Thermometer calibration log** | verification | probe · ice-point check · pass/adjust · initials | **daily** | each cook | paper / HUB | 2 yr* |
| 6 | **Corrective-action log** | Principle 5 | what failed · when · action · disposition (use/discard) · who | only on a deviation | whoever finds it | HUB / paper | 2 yr* |
...
| **CCP-3 Chilled/ROP hold + transport** | *Listeria*; *C. botulinum* toxin over time | cold ≤**4 °C [BINDING]** · **ROP ≤4 °C + validated barrier** (≥90 °C/10-min cook or pH/aw/salt) · use-by **≤7 d** (Listeria Cat 1) · transit ≤4 °C **[BINDING]** | cold chain + dated discard-by label; validated transport | fridge **2×/day** · label **every bag** · transport equipment validated · lead | Logs 2, 3, 7 | over-temp/over-date → **discard**; repair/relocate |
...
| "How long do you keep records?" | **2 years** (CONC commitment; ≥1 yr statutory floor). |
...
*Working draft — **voluntary** HACCP plan. Limit values sync from `HACCP_HAZARD_ANALYSIS.md` §4 (validated 2026-06-24). Retention: **2 years** (CONC commitment). Part of the HACCP set — see the index in `HACCP_PRELIMINARY_HAZARD_ANALYSIS.md`.*
