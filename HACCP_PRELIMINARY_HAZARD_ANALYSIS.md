...
**Date:** 2026-06-24 · **Status: PRELIMINARY / DRAFT** — not a validated or live plan. Every critical limit is pending Toronto Public Health (TPH) validation; the process flows are pending on-site confirmation.
...
| CCP | Step | Critical limit *(pending TPH)* |
|---|---|---|
...
- **Minor items to validate:** fish cooked to 155 °F vs Health Canada's 158 °F; no documented transport-temperature spec; a few hold-day anomalies (a 27-day and some "?d" entries) to classify.
...
2. **TPH validation** of all critical limits — and a ruling on whether the vacuum/ROP special process needs a **variance**.
